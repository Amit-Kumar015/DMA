  ...
  const fetchSearchResults = async query => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://52.70.194.52/api/core/global-search/?q=${query}`,
        {
          headers: {
    ...
    <SafeAreaView
      ...
      <Header
        ...
        searchProps={{
          ...
          clearIcon: <Icon name="clear" type="material" size={10} />,
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <LottieView
              source={{
                uri: 'https://assets5.lottiefiles.com/packages/lf20_puciaact.json',
              }}
              autoPlay
              loop
...
const styles = StyleSheet.create({
  ...
  emptyContainer: {
    flex: 1,
    height: hp('30%'), // ✅ ensure enough height
    alignItems: 'center',
