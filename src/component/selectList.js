        ...
        <View style={[styles.wrapper, boxStyles]}>
          <View style={{flexDirection: 'row', alignItems: 'center', flex: 1}}>
            ...
            <TouchableOpacity onPress={() => slideup()}>
              {!closeicon ? (
                <Icon name="close" size={iconSizeSmallSm} />
              ) : (
                closeicon
              )}
            </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text
            ...
            style={[
              {
                fontFamily,
                color: "black", // or any color like '#000' or theme.$primary
                opacity:
                  selectedval === '' || filtereddata.length === 0 ? 0.5 : 1,
              },
              inputStyles,
              {width: '94%'},
            ]}>
